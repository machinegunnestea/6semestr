...
const app = require("../lab5_1/app").app;
    ...
    describe("GET /movie?id=3 ADDED", () => {
        it("Should return 200 \"OK\" with expected JSON", (done) => {
          request(app)
            ...
            .expect(200)
            .expect((response) => {
                assert.deepStrictEqual(response.body, movie3);
            })
            .end(done);
        });
    });
    ...
    describe("GET /movie?id=3 UPDATED", () => {
        it("Should return 200 \"OK\" with expected JSON", (done) => {
          request(app)
            ...
            .expect(200)
            .expect((response) => {
                assert.deepStrictEqual(response.body, movie3_upd);
            })
            .end(done);
        });
    });

    describe("DELETE /movie with id=3 EXISTENT", () => {
        it("Should return 200 \"OK\" with Text", (done) => {
          request(app)
            .delete("/movie")
            .query({id: 3})
